...
export const experiences: Experience[] = [
    {
        ...
        position: {
            en: 'Full Stack Developer Intern (Java / React)',
            fr: 'Stagiaire Développeur Full Stack (Java / React)'
        },
        duration: {
            en: 'Aug 2025 - Jan 2026',
            fr: 'Août 2025 - Jan 2026'
        },
        location: {
        ...
        description: {
            en: [
                'Developed backend microservices and React frontend for the Ministry of Health portal',
                ...
                'Deployed backend using Nginx (reverse proxy) and React frontend using PM2',
                ...
                'Automated large-scale data extraction and transfer from the old Ministry website to the new platform using custom bulk download/upload scripts, improving migration efficiency by 80%'
            ],
            fr: [
                'Développement de microservices backend et d’un frontend React pour le portail du Ministère de la Santé',
                ...
                'Déploiement du backend utilisant Nginx (reverse proxy) et du frontend React utilisant PM2',
                ...
                'Automatisation du téléchargement et de l’upload massif (scraping) depuis l’ancien site du Ministère vers la nouvelle plateforme à l’aide de scripts de bulk download/upload, augmentant l’efficacité de la migration de 80%'
            ]
        },
        technologies: [
            'React',
    ...
    },
    {
        ...
        description: {
            ...
            fr: [
                ...
                'Atteinte de 80% de couverture de tests utilisant JUnit et Mockito'
            ]
        },
        technologies: [
            'Spring Boot',
